...
var theme_source = {
  lib_source:{
      ...
      setTimeout(function(){
        ...
        var shipp_price =  parseFloat(shipping_price.replace(/[^0-9-.]/g, ''));
         ...
         if(shipp_price == ''){
          ...
          $('#free_shipping_price').html('Free shipping for orders above<span class="money"><span class=money>$500.00 USD</span></span>');                             
    ...
    addtocart_product: function(id, qty,                                                                                              
...
jQuery(document).on('click', '.add_to_cart_btn_cls', function(){
 ...
 $(".quantity-right-plus").on("click", function(t) {
        var e = $(this).data("id");
     // console.log('ee', e);
        var i = parseInt($('#quantity_'+e).val()) + 1 ;
      //console.log('ii', i);
        ...
        var a = $('#quantity_'+e),
            n = {
              ...
              dataType: "json",
              success: function() {
                theme_source.lib_source.on_cart_update(a, !0);
              },
              error: function(t, e) {
                Shopify.onError(t, e)
              }
      ...
      $(".quantity-left-minus").on("click", function(t) {
        var e = $(this).data("id");
            console.log('ee', e);
            var i = parseInt($('#quantity_'+e).val()) ;
             console.log('ii', i);
